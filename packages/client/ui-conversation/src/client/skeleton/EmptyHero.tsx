...
import {
  BrainIcon, IconChevronDownOutline14, IconFolderClose16, IconFolderOpen16,
    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          {/* The 34px brand mark leads the headline with a 10px gap. */}
          <span className={css.brandHitbox}>
            {renderSlot('conversation.hero.brand.mark', { size: 34, className: css.brandMark }, {
              fallback: <BrainIcon size={34} className={css.brandMark} />,
            })}
          </span>
