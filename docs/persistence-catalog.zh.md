...
来源：[`packages/geo/geo-command/src/types.ts:136`](../packages/geo/geo-command/src/types.ts)
...
来源：[`packages/geo/geo-view/src/types.ts:78`](../packages/geo/geo-view/src/types.ts)
