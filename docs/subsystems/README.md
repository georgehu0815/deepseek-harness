...
| [robot.md](robot.md) | Robot Lab model profiles, experimental targets, immutable project/music recipes, training admission, kinematic previews and measured simulation telemetry |
