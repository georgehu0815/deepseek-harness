...
来源：[`packages/hooks/cc-commands/src/index.ts:31`](../packages/hooks/cc-commands/src/index.ts)
...
来源：[`packages/credentials/credentials-local/src/index.ts:79`](../packages/credentials/credentials-local/src/index.ts)
...
来源：[`packages/geo/geo/src/index.ts:54`](../packages/geo/geo/src/index.ts)
...
来源：[`packages/geo/geo-viewcontext/src/index.ts:29`](../packages/geo/geo-viewcontext/src/index.ts)
...
来源：[`packages/host/geo-bff/src/index.ts:35`](../packages/host/geo-bff/src/index.ts)
...
来源：[`packages/mcp/mcp-client/src/index.ts:116`](../packages/mcp/mcp-client/src/index.ts)
...
来源：[`packages/robot/robot-lab-microduck/src/index.ts:23`](../packages/robot/robot-lab-microduck/src/index.ts)
...
来源：[`packages/supply-chain/supply-chain/src/index.ts:70`](../packages/supply-chain/supply-chain/src/index.ts)

<a id="deepseek-aidsh-supply-chain-isomorph"></a>

## `@deepseek-ai/dsh-supply-chain-isomorph`

需要：`supplyChain` · `subprocess`
...
来源：[`packages/supply-chain/supply-chain-isomorph/src/index.ts:38`](../packages/supply-chain/supply-chain-isomorph/src/index.ts)
...
- `@deepseek-ai/dsh-experimental-plugin-student-stats` — 需要 `agents`（[`packages/experimental/plugin-student-stats/src/index.ts`](../packages/experimental/plugin-student-stats/src/index.ts)）
- `@deepseek-ai/dsh-fs-e2b` — 需要 `e2b`（[`packages/e2b/fs-e2b/src/index.ts`](../packages/e2b/fs-e2b/src/index.ts)）
- `@deepseek-ai/dsh-fs-observation-policy`（[`packages/fs/fs-observation-policy/src/index.ts`](../packages/fs/fs-observation-policy/src/index.ts)）
- `@deepseek-ai/dsh-geo-command` — 需要 `sessionProjections`（[`packages/geo/geo-command/src/index.ts`](../packages/geo/geo-command/src/index.ts)）
...
- `@deepseek-ai/dsh-tool-geo-control` — 需要 `tools`（[`packages/geo/tool-geo-control/src/index.ts`](../packages/geo/tool-geo-control/src/index.ts)）
- `@deepseek-ai/dsh-tool-geo-query` — 需要 `tools` · `geo`（[`packages/geo/tool-geo-query/src/index.ts`](../packages/geo/tool-geo-query/src/index.ts)）
- `@deepseek-ai/dsh-tool-subagent-control` — 需要 `tools` · `subagents`（[`packages/subagent/tool-subagent-control/src/index.ts`](../packages/subagent/tool-subagent-control/src/index.ts)）
- `@deepseek-ai/dsh-tool-supply-chain` — 需要 `tools` · `supplyChain`（[`packages/supply-chain/tool-supply-chain/src/index.ts`](../packages/supply-chain/tool-supply-chain/src/index.ts)）
