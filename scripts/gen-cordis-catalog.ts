...
export const LINK_MAP: Readonly<Record<string, string>> = {
  RobotLabProvider: 'robot.md',
  RobotLabRequest: 'robot.md',
  RobotLabResult: 'robot.md',
  RobotProfileId: 'robot.md',
  RobotTemplateId: 'robot.md',
  RobotProjectId: 'robot.md',
  RobotProjectRevisionId: 'robot.md',
  RobotProfile: 'robot.md',
  RobotMusicRecipe: 'robot.md',
  RobotStudioParameters: 'robot.md',
  RobotTemplate: 'robot.md',
  RobotStudioCatalog: 'robot.md',
  RobotMotionBlock: 'robot.md',
  RobotProjectBlock: 'robot.md',
  RobotProjectTraining: 'robot.md',
  RobotProjectRecipe: 'robot.md',
  RobotProjectRevision: 'robot.md',
  RobotReferencePreview: 'robot.md',
  RobotTelemetry: 'robot.md',
  RobotFrame: 'robot.md',
  RobotSimulation: 'robot.md',
  RobotTrainingRequest: 'robot.md',
  RobotTrainingSpec: 'robot.md',
  Agent: 'core.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SimulationRun: 'completed supply-chain run record is owned by packages/supply-chain/supply-chain/README.md',
  SimulationConfig: 'supply-chain scenario settings are owned by packages/supply-chain/supply-chain/README.md',
  SupplyChainProvider: 'supply-chain provider contract is owned by packages/supply-chain/supply-chain/README.md',

  NodeReport: 'per-facility supply-chain report is owned by packages/supply-chain/supply-chain/README.md',
  BullwhipReport: 'order-variance supply-chain report is owned by packages/supply-chain/supply-chain/README.md',
  EdgeReport: 'lane-pressure supply-chain report is owned by packages/supply-chain/supply-chain/README.md',
  SessionSummary: 'completed tracked-session record is owned by packages/experimental/plugin-student-stats/README.md',
